...
type El1
  = forall a. Array (C.ReactProps a) -> C.Widget C.HTML a -> C.Widget C.HTML a

type El1'
  = forall a. C.Widget C.HTML a -> C.Widget C.HTML a

------------------------------------------------------------------------------
-- From purescript-react-mui. Unused now though.
button :: C.El
